...
struct ar_head {
	size_t len, cap;
	byte elms[]; // this is where the data lives. byte is just a placeholder and does not represent the actual type
};
...
#define arpush(p, val) do { *arpushm(p, 1) = val; } while (0)
